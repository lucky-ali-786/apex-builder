...
* npm, pnpm, or yarn
* A running PostgreSQL database (local or a cloud provider like Neon/Supabase)

### 1. Clone & Install

```bash
git clone [https://github.com/lucky-ali-786/apex-builder.git](https://github.com/lucky-ali-786/apex-builder.git)
cd apex-builder
npm install
```
